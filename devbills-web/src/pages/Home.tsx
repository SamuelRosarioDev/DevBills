	...
	const features: ReadonlyArray<Feature> = [
		{
			...
			description:
				"Monitore suas despensas e receitas em um só lugar, com uma interface intuitiva e fácil de usar.",
		},
		{
			icon: (
				<Icon
	...
	return (
		<div className="bg-gray-950 min-h-screen">
			<div className="container-app">
					...
					<div className="container-app">
						<div className="text-center mb-12">
							...
							<p className="text-lg text-white max-w-2xl mx-auto">
								Nossas plataforma oferece tudo o que você precisa para manter
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 ">
							{features.map((feature) => (
								<div
									...
									key={feature.title}
								>
									<div className="mb-4 bg-primary-500/10 p-3 rounded-full inline-block leading-none">
										{feature.icon}
									</div>
				...
				<section className="py-12 md:py-20">
					<div className="bg-gray-900 rounded-xl p-8 md:p-12 text-center border border-gray-700">
